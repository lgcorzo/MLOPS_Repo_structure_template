...
from Code.Application.smart_machine_config_algorithm import read_file

cwd = os.path.dirname(os.path.abspath(__file__))
CNC_PATH = os.path.join(cwd, 'Fixtures')
CNC_FILE_PATH = os.path.join(CNC_PATH, '2.NC')
PKL_PATH = os.path.join(CNC_PATH, 'smart_machine_config_model.pkl')
CSV_PATH = os.path.join(CNC_PATH, 'test_list_cnc.csv')


@mock.patch('Code.Application.Services.model_services.cnc_path', CNC_PATH)
@mock.patch('Code.Application.smart_machine_config_evaluation.pkl_path', PKL_PATH)
...
@mock.patch('Code.Application.smart_machine_config_evaluation.cnc_path', CNC_PATH)
@mock.patch('Code.Application.smart_machine_config_evaluation.pkl_path', PKL_PATH)
